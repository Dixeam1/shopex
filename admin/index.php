          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/products/add_products.php">Add Product</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/products/view_products.php">View Product</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="pages/Category/add_category.php">Add Category</a></li>
                  <li class="nav-item"><a class="nav-link" href="pages/Category/view_category.php">View Category</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/customer/customer.php">
                <i class="menu-icon mdi mdi-chart-line"></i>
                <span class="menu-title">Custommer</span>
              </a>
            </li><li class="nav-item">
              <a class="nav-link" href="pages/payment/payment.php">
                <i class="menu-icon mdi mdi-chart-line"></i>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/user/add_user.php"> Add User </a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/user/view_user.php"> View User </a></li>
                </ul>
              </div>
