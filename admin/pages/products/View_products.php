                      ...
                      <tbody>
                        ...
                        foreach($result as $res){
                         ...
                         <tr>
                          ...
                          <td><img style="width: 50px;" src="uploads/<?php echo $res['images'];?>"></td>
                          <td>
                            <a href="delete.php?id=<?php echo $res['id']?>">Delete<i class=" fas fa-trash-alt text text-danger " style="font-size: 25px;"></i></a>
                            <a href="update.php?id=<?php echo $res['id']?>">Update<i class=" fas fa-trash-alt text text-danger " style="font-size: 25px;"></i></a>
                            <a href="view.php?id=<?php echo $res['id']?>">View<i class=" fas fa-trash-alt text text-danger " style="font-size: 25px;"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
